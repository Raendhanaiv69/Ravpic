...
<body class="text-[#6E4B4B] antialiased">
    ...
    <script>
        ...
        function drawEmptyStrip() {
            ...
            stripCanvas.height = 980;

            sCtx.fillStyle = '#FFF0F3';
            sCtx.fillRect(0, 0, 400, 980);

            sCtx.strokeStyle = '#FFD2DC';
            sCtx.lineWidth = 4;
            sCtx.strokeRect(10, 10, 380, 960);

            sCtx.fillStyle = '#FFFFFF';
            for (let i = 0; i < 3; i++) {
                sCtx.fillRect(25, 25 + i * 295, 350, 280);
                sCtx.strokeStyle = '#FFE0E6';
                sCtx.strokeRect(25, 25 + i * 295, 350, 280);
            }

            sCtx.fillStyle = '#C27C88';
            sCtx.font = 'bold 16px "Quicksand", sans-serif';
            sCtx.textAlign = 'center';
            sCtx.fillText('Hasil foto 1:1 akan muncul di sini ✨', 200, 460);
        }
        drawEmptyStrip();
        ...
        class ColorfulGoldfish {
            ...
            reset(initial = false) {
                ...
                this.isNearLens = Math.random() < 0.35;
                this.scale = this.isNearLens ? (Math.random() * 0.35 + 0.85) : (Math.random() * 0.2 + 0.45);
        ...
        const fishes = Array.from({ length: 5 }, () => new ColorfulGoldfish());
        const bubbles = Array.from({ length: 14 }, () => new Bubble());
        ...
        function renderPhotostripLive() {
            ...
            bgGrad.addColorStop(0.5, '#FFEBF0');
            bgGrad.addColorStop(1, '#FFDEE9');
            sCtx.fillStyle = bgGrad;
            sCtx.fillRect(0, 0, stripW, stripH);

            sCtx.strokeStyle = '#FFCCD5';
            sCtx.lineWidth = 6;
            ...
            for (let i = 0; i < 3; i++) {
                ...
                sCtx.save();
                sCtx.shadowColor = 'rgba(234, 124, 143, 0.2)';
                sCtx.shadowBlur = 8;
        ...
        function downloadStrip() {
            ...
            link.download = `photobooth-square-aquarium-${Date.now()}.png`;
